# LIO-SAM_CC_Comments
## Introduction
本仓库是[LIO-SAM](https://github.com/TixiaoShan/LIO-SAM)的详细中文注释，如果你想快速了解LIO-SAM的论文思想和工程代码架构，可以参考我的博客:
- [LIO-SAM论文与代码阅读笔记（一）论文阅读](https://blog.csdn.net/qq_42731705/article/details/127833557)
- [LIO-SAM论文与代码阅读笔记（二）代码阅读：imuPreintergration.cpp和imageProjection.cpp](https://blog.csdn.net/qq_42731705/article/details/127833653)
- [LIO-SAM论文与代码阅读笔记（三）代码阅读：featureExtraction.cpp和mapOptmization.cpp](https://blog.csdn.net/qq_42731705/article/details/127833705)

## Done
- imuPreintegration.cpp 全部内容
- imageProjection.cpp 全部内容
- featureExtraction.cpp 全部内容
- mapOptmization.cpp 中除了回环检测外的绝大部分内容
